...
public class ConnectionAnniversaryNotification implements NotificationService {
    private String id;
    private User user;
    private  String content;
    private Timestamp timestamp;

    public ConnectionAnniversaryNotification(String id, User user, String content, Timestamp timestamp) {
        this.id = id;
        this.user = user;
